...
class MyFirstServiceClient implements \phpExample\MyFirstServiceIf
{
    ...
    {
        $args = new \phpExample\MyFirstService_log_args();
    ...
    {
        $args = new \phpExample\MyFirstService_multiply_args();
    ...
    public function recv_multiply()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\phpExample\MyFirstService_multiply_result',
            ...
            $result = new \phpExample\MyFirstService_multiply_result();
    ...
    {
        $args = new \phpExample\MyFirstService_get_log_size_args();
        $args->filename = $filename;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
    ...
    public function recv_get_log_size()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\phpExample\MyFirstService_get_log_size_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \phpExample\MyFirstService_get_log_size_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
